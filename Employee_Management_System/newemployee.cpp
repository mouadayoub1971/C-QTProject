    ...
    ui(new Ui::NewEmployee)
{
    ...
    myMessage.setStyleSheet(styleSheet);
     ...
     ui->username_input->setStyleSheet("QWidget { color:black; }");
     ui->password_input->setStyleSheet("QWidget { color:black; }");
     ui->id_input->setStyleSheet("QWidget { color:black; }");
     ui->name_input->setStyleSheet("QWidget { color:black; }");
    ui->age_spinbox->setStyleSheet("QWidget { color:black; }");
    ui->gender_combobox->setStyleSheet("QWidget { color:black; }");
     ui->department_input->setStyleSheet("QWidget { color:black; }");
    ui->email_input->setStyleSheet("QWidget { color:black; }");
     ui->mobile_input->setStyleSheet("QWidget { color:black; }");
     ui->cnic_input->setStyleSheet("QWidget { color:black; }");
     ui->salary_input->setStyleSheet("QWidget { color:black; }");
    ui->experience_spinbox->setStyleSheet("QWidget { color:black; }");
...
void NewEmployee::on_pushButton_clicked()
{
    ...
    QSqlDatabase db4 = QSqlDatabase::addDatabase("QSQLITE");
        ...
        myMessage.setText("Employee Added");
        myMessage.exec();
        accept();
}
